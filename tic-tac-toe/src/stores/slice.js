...
export const { markStrikeCell, updateActionCell, markWinnerFound, updateTurnUser, resetBoard, openNavbar, customizeBoard, openModal, updateRowsColumns } = boardSlice.actions
